...
export const postApplication = catchAsyncErrors(async(req,resizeBy,next)=>{
    ...
    if(req.files && req.files.resume){
        ...
        try{
            ...
            return next(new ErrorHandler("Failed to upload rsume.",500)); //internal server error
        }
    }
    else{
...
export const deleteApplication = catchAsyncErrors(async(req,resizeBy,next)=>{
    ...
    //if application has been deleted by both employer and job seeker
    //then it doesnt need to be in our db
